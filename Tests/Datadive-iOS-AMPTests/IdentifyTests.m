...
- (void)testAddProperty {
    ...
    DDIdentify *identify = [[DDIdentify identify] add:property1 value:value1];
...
- (void)testSetProperty {
    ...
    DDIdentify *identify = [[DDIdentify identify] set:property1 value:value1];
...
- (void)testSetOnceProperty {
    ...
    DDIdentify *identify = [[DDIdentify identify] setOnce:property1 value:value1];
...
- (void)testAppendProperty {
    ...
    DDIdentify *identify = [[DDIdentify identify] append:property1 value:value1];
...
- (void)testPrependProperty {
    ...
    DDIdentify *identify = [[DDIdentify identify] prepend:property1 value:value1];
