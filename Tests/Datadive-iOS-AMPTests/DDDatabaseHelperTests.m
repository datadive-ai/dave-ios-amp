...
@interface DDDatabaseHelperTests : XCTestCase
@property (nonatomic, strong)  DDDatabaseHelper *databaseHelper;
@end

@implementation DDDatabaseHelperTests {}
...
- (void)testGetIdentifys {
    ...
    XCTAssert([[[events objectAtIndex:0] objectForKey:@"event_type"] isEqualToString:DD_IDENTIFY_EVENT]);
    XCTAssertEqual(1, [[[events objectAtIndex:0] objectForKey:@"event_id"] longValue]);
    XCTAssert([[[events objectAtIndex:1] objectForKey:@"event_type"] isEqualToString:DD_IDENTIFY_EVENT]);
    XCTAssertEqual(2, [[[events objectAtIndex:1] objectForKey:@"event_id"] longValue]);
