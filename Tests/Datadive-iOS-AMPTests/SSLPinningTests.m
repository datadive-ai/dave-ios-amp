...
- (void)testSSLPinningInvalidCert {
    ...
    [DDURLSession sharedSession]; // trigger static instance to pin valid certificates, then pin the invalid one
    [DDURLSession pinSSLCertificate:@[@"InvalidCertificationAuthority"]];
